...
requiredCapabilities: workspace.read,workspace.write,workspace.execute,workspace.manage,machine.files.read,machine.files.write,machine.shell.execute,browser.read,browser.interact,artifacts.read
---
